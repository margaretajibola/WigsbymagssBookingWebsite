...
export default function ServiceForm({ editingService, onSave, onCancel }: Props) {
  ...
  return (
    ...
    >
        ...
        <div className="flex flex-col">
            <label htmlFor="price" className="text-md font-medium text-gray-700 mb-1">
                Price:
            </label>
            <input
                id="price"
        ...
        <div className="flex flex-col">
            <label htmlFor="extraNotes" className="text-md font-medium text-gray-700 mb-1">
                Extra Notes:
            </label>
            <input
                id="extraNotes"
        ...
        <div className="flex flex-col">
            <label htmlFor="category" className="text-md font-medium text-gray-700 mb-1">
                Category:
            </label>
            <select
                id="category"
